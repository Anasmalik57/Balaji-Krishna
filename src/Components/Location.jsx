      ...
      <div className="bg-white p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <div className="border rounded overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4665.065017238753!2d73.11028069999999!3d19.2226464!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be795256eeb6eed%3A0x5a2431c898802c6!2sBalaji%20Krishna!5e1!3m2!1sen!2sin!4v1745909035577!5m2!1sen!2sin"
                width="100%"
                height="300"
                allowFullScreen=""
                loading="lazy"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-6 text-black text-md font-medium">
          <p className="flex items-center-safe">
            ...
            <span>Dombivli Railway Station - 2 KM</span>
          </p>
          <p className="flex items-center-safe">
            <span>
              <MdOutlineLocationOn />
            </span>{" "}
            <span>Thakurli Railway Station - 1 KM</span>
          </p>
          <p className="flex items-center-safe">
            <span>
              <MdOutlineLocationOn />
            </span>{" "}
            <span>Model College - 100 Metre</span>
          </p>
          <p className="flex items-center-safe">
            <span>
              <MdOutlineLocationOn />
            </span>{" "}
            <span>Greenwood International School - 100 Metre</span>
          </p>
          <p className="flex items-center-safe">
            <span>
              <MdOutlineLocationOn />
            </span>{" "}
            <span>Manjunath College - 200 Metre</span>
          </p>
        </div>
      </div>
