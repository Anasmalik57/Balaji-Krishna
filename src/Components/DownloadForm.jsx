              ...
              <div className="text-xs">
                <label className="inline-flex items-start">
                  ...
                  <span className='text-[10px]'>
                    ...
                    I Authorize Balaji Krishna Advisors and its representatives to Call, SMS, Email or WhatsApp Me About Its Products and Offers. This Consent Overrides Any Registration For DNC/NDNC.
                  </span>
                </label>
              </div>
